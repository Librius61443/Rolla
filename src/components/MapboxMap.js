...
import { mapTheme, createMapStyle, colors } from '../styles/theme';
...
export default function MapboxMap({ is3D = true, theme = mapTheme }) {
  ...
  // Memoize HTML content so it only changes when coords or theme change
  ...
  return (
    <View style={styles.container}>
      {loading && (
        <View style={[styles.loadingOverlay, { backgroundColor: theme.primary }]}>
